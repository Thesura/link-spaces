...
CREATE TABLE `comments_events` (
  ...
  CONSTRAINT `comments_events_ibfk_1` FOREIGN KEY (`poster_id`) REFERENCES `users` (`uid`),
  CONSTRAINT `comments_events_ibfk_2` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`)
...
--
-- Table structure for table `comments_jobs`
--
...
CREATE TABLE `comments_jobs` (
  ...
  KEY `poster_id` (`poster_id`),
  KEY `job_id` (`job_id`),
  CONSTRAINT `comments_jobs_ibfk_1` FOREIGN KEY (`poster_id`) REFERENCES `users` (`uid`),
  CONSTRAINT `comments_jobs_ibfk_2` FOREIGN KEY (`job_id`) REFERENCES `job_offers` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `comments_jobs`
--
...
INSERT INTO `students` VALUES (4,'Thesura','Siriwardhana','1997-07-15','NSBM','139'),(5,'Asiri','Perera','1996-05-21','NSBM','145');
...
INSERT INTO `users` VALUES (2,'Chamod','123','student','ch@gmail.com'),(3,'Imalka','456','student','im@gmail.com'),(4,'thesura','tj1997','student','thesuracom@gmail.com'),(5,'asiri','[-67, 9, -77, 32, 96, 121, -4, 91, 109, -11, -62, -60, 105, -79, 121, 25, 17, -77, 122, 12, 97, 97, -76, -70, -80, 51, -115, 63, -36, 97, -128, -103]','student','asiri@gmail.com');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'link_spaces'
--
...
-- Dump completed on 2019-06-07 10:35:02
